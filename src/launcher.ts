...
export function createConnectingmatrixSocketsStubLauncher(context: RequestContext = {}): PackageLauncherPanel {
  return {
    ...
    actions: [
      ...
      { name: 'broadcast', label: 'broadcast', method: 'LOCAL' as const, description: 'Run broadcast demo action' },
      { name: 'on', label: 'on', method: 'LOCAL' as const, description: 'Run on demo action' },
      { name: 'emitLog', label: 'emitLog', method: 'LOCAL' as const, description: 'Run emitLog demo action' }
    ],
...
export const Launcher = { open: createConnectingmatrixSocketsStubLauncher, mode: 'stub' as const };
